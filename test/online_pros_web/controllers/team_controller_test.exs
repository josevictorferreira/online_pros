defmodule OnlineProsWeb.TeamControllerTest do
  use OnlineProsWeb.ConnCase

  alias OnlinePros.Esports

  @game %{game: "some image", name: "some name"}
  @league %{image: "some image", name: "some name", game: @game}
  @create_attrs %{image: "some image", name: "some name", league: @league}
  @update_attrs %{image: "some updated image", name: "some updated name", league: @league}
  @invalid_attrs %{image: nil, name: nil, league: nil}

  def fixture(:team) do
    {:ok, team} = Esports.create_team(@create_attrs)
    team
  end
  ...
  describe "create team" do
    test "redirects to show when data is valid", %{conn: conn} do
      ...
      assert html_response(conn, 200) =~ "Team Details"
    end
